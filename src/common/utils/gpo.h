...
namespace powertoys_gpo
{
    ...
    const std::wstring POLICY_CONFIGURE_ENABLED_MCP_SERVER = L"ConfigureEnabledUtilityMcpServer";
...
#pragma region UtilityEnabledStatePolicies
    ...
    inline gpo_rule_configured_t getConfiguredMcpServerEnabledValue()
    {
        return getUtilityEnabledValue(POLICY_CONFIGURE_ENABLED_MCP_SERVER);
    }
